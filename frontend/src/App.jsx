            ...
            reports.map((report, key) => (
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  <div className="text-xl font-semibold">{report.storeName}</div>
                  ...
                  <tbody>
                    {report.transactions.map((transacao, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-gray-100' : ''}>
                        <td className="px-4 py-2">{transacao.card}</td>
                        <td className="px-4 py-2">{transacao.cpf}</td>
                        <td className="px-4 py-2">{transacao.createdAt}</td>
                        <td className="px-4 py-2">{transacao.storeOwner}</td>
                        <td className="px-4 py-2">{transacao.dateHour}</td>
                        <td className="px-4 py-2">{transacao.storeName}</td>
                        <td className="px-4 py-2">{transacao.type}</td>
                        <td className="px-4 py-2">{formatCurrency(transacao.amount)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
